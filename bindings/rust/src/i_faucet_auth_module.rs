...
```*/
    ...
    ///Container for all the [`IFaucetAuthModule`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IFaucetAuthModuleCalls {
        #[allow(missing_docs)]
        verify(verifyCall),
    }
    impl IFaucetAuthModuleCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[216u8, 85u8, 129u8, 79u8]];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IFaucetAuthModuleCalls {
        const NAME: &'static str = "IFaucetAuthModuleCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IFaucetAuthModuleCalls>] = &[
                {
                    fn verify(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IFaucetAuthModuleCalls> {
                        <verifyCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IFaucetAuthModuleCalls::verify)
                    }
                    verify
                },
            ];
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IFaucetAuthModule`](self) contract instance.

See the [wrapper's documentation](`IFaucetAuthModuleInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        __provider: P,
    ) -> IFaucetAuthModuleInstance<P, N> {
        IFaucetAuthModuleInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IFaucetAuthModuleInstance<P, N>>,
    > {
        IFaucetAuthModuleInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IFaucetAuthModuleInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`IFaucetAuthModule`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IFaucetAuthModule`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IFaucetAuthModuleInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IFaucetAuthModuleInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IFaucetAuthModuleInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    impl<
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IFaucetAuthModuleInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IFaucetAuthModuleInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IFaucetAuthModuleInstance<P, N> {
            IFaucetAuthModuleInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }
