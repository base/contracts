...
```*/
    ...
    ///Container for all the [`L1FeeVault`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for L1FeeVaultCalls {
        const NAME: &'static str = "L1FeeVaultCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<L1FeeVaultCalls>] = &[
                {
                    fn RECIPIENT(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<L1FeeVaultCalls> {
                        <RECIPIENTCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(L1FeeVaultCalls::RECIPIENT)
                    }
                    RECIPIENT
                },
                {
                    fn setWithdrawalNetwork(
                        ...
                        <setWithdrawalNetworkCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(L1FeeVaultCalls::setWithdrawalNetwork)
                    }
                ...
                },
                {
                    fn setRecipient(
                        ...
                        <setRecipientCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(L1FeeVaultCalls::setRecipient)
                    }
                    setRecipient
                },
                {
                    fn withdraw(
                        ...
                        <withdrawCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(L1FeeVaultCalls::withdraw)
                    }
                    withdraw
                },
                {
                    fn version(data: &[u8]) -> alloy_sol_types::Result<L1FeeVaultCalls> {
                        <versionCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(L1FeeVaultCalls::version)
                    }
                    version
                },
                {
                ...
                },
                {
                    fn withdrawalNetwork(
                        ...
                        <withdrawalNetworkCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(L1FeeVaultCalls::withdrawalNetwork)
                    }
                    withdrawalNetwork
                },
                {
                    fn minWithdrawalAmount(
                        ...
                        <minWithdrawalAmountCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(L1FeeVaultCalls::minWithdrawalAmount)
                    }
                    minWithdrawalAmount
                },
                {
                    fn totalProcessed(
                        ...
                        <totalProcessedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(L1FeeVaultCalls::totalProcessed)
                    }
                    totalProcessed
                },
                {
                    fn setMinWithdrawalAmount(
                        ...
                        <setMinWithdrawalAmountCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(L1FeeVaultCalls::setMinWithdrawalAmount)
                    }
                ...
                },
                {
                    fn initialize(
                        ...
                        <initializeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(L1FeeVaultCalls::initialize)
                    }
                    initialize
                },
                {
                    fn WITHDRAWAL_NETWORK(
                        ...
                        <WITHDRAWAL_NETWORKCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(L1FeeVaultCalls::WITHDRAWAL_NETWORK)
                    }
                    WITHDRAWAL_NETWORK
                },
                {
                    fn MIN_WITHDRAWAL_AMOUNT(
                        ...
                        <MIN_WITHDRAWAL_AMOUNTCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(L1FeeVaultCalls::MIN_WITHDRAWAL_AMOUNT)
                    }
    ...
    ///Container for all the [`L1FeeVault`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum L1FeeVaultErrors {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for L1FeeVaultErrors {
        const NAME: &'static str = "L1FeeVaultErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<L1FeeVaultErrors>] = &[
                {
                    fn FeeVault_OnlyProxyAdminOwner(
                        ...
                        <FeeVault_OnlyProxyAdminOwner as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(L1FeeVaultErrors::FeeVault_OnlyProxyAdminOwner)
                    }
                ...
                },
                {
                    fn NotInitializing(
                        ...
                        <NotInitializing as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(L1FeeVaultErrors::NotInitializing)
                    }
                    NotInitializing
                },
                {
                    fn InvalidInitialization(
                        ...
                        <InvalidInitialization as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(L1FeeVaultErrors::InvalidInitialization)
                    }
    ...
    ///Container for all the [`L1FeeVault`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for L1FeeVaultEvents {
        const NAME: &'static str = "L1FeeVaultEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for L1FeeVaultEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`L1FeeVault`](self) contract instance.

See the [wrapper's documentation](`L1FeeVaultInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        __provider: P,
    ) -> L1FeeVaultInstance<P, N> {
        L1FeeVaultInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<L1FeeVaultInstance<P, N>>,
    > {
        L1FeeVaultInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        L1FeeVaultInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`L1FeeVault`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`L1FeeVault`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct L1FeeVaultInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for L1FeeVaultInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("L1FeeVaultInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    impl<
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<L1FeeVaultInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> L1FeeVaultInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> L1FeeVaultInstance<P, N> {
            L1FeeVaultInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
