...
```*/
    ...
    ///Container for all the [`ResourceMetering`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum ResourceMeteringCalls {
        #[allow(missing_docs)]
        params(paramsCall),
    }
    impl ResourceMeteringCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[207u8, 240u8, 171u8, 150u8]];
        /// The names of the variants in the same order as `SELECTORS`.
        pub const VARIANT_NAMES: &'static [&'static str] = &[::core::stringify!(params)];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ResourceMeteringCalls {
        const NAME: &'static str = "ResourceMeteringCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<ResourceMeteringCalls>] = &[
                {
                    fn params(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<ResourceMeteringCalls> {
                        <paramsCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ResourceMeteringCalls::params)
                    }
                    params
                },
            ];
    ...
    ///Container for all the [`ResourceMetering`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum ResourceMeteringErrors {
        #[allow(missing_docs)]
        OutOfGas(OutOfGas),
    }
    impl ResourceMeteringErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
        ///
        /// Prefer using `SolInterface` methods instead.
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[119u8, 235u8, 239u8, 77u8]];
        /// The names of the variants in the same order as `SELECTORS`.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ResourceMeteringErrors {
        const NAME: &'static str = "ResourceMeteringErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        const COUNT: usize = 1usize;
        #[inline]
        fn selector(&self) -> [u8; 4] {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<ResourceMeteringErrors>] = &[
                {
                    fn OutOfGas(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<ResourceMeteringErrors> {
                        <OutOfGas as alloy_sol_types::SolError>::abi_decode_raw(data)
                            .map(ResourceMeteringErrors::OutOfGas)
                    }
                    OutOfGas
                },
            ];
    ...
    ///Container for all the [`ResourceMetering`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum ResourceMeteringEvents {
        #[allow(missing_docs)]
        Initialized(Initialized),
    }
    impl ResourceMeteringEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ResourceMeteringEvents {
        const NAME: &'static str = "ResourceMeteringEvents";
        const COUNT: usize = 1usize;
        fn decode_raw_log(
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ResourceMeteringEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`ResourceMetering`](self) contract instance.

See the [wrapper's documentation](`ResourceMeteringInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> ResourceMeteringInstance<P, N> {
        ResourceMeteringInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ResourceMeteringInstance<P, N>>,
    > {
        ResourceMeteringInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ResourceMeteringInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`ResourceMetering`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ResourceMetering`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ResourceMeteringInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ResourceMeteringInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ResourceMeteringInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ResourceMeteringInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ResourceMeteringInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ResourceMeteringInstance<P, N> {
            ResourceMeteringInstance {
