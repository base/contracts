...
contract DoubleNestedMultisigBuilderTest is Test, DoubleNestedMultisigBuilder {
    ...
    function test_sign_double_nested_safe1() external {
        vm.recordLogs();
        bytes memory txData = abi.encodeWithSelector(bytes4(keccak256("sign(address,address)")), safe1, safe3);
    ...
    function test_sign_double_nested_safe2() external {
        vm.recordLogs();
        bytes memory txData = abi.encodeWithSelector(bytes4(keccak256("sign(address,address)")), safe2, safe3);
