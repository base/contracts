...
contract TestWithdraw is Script {
    function run(address tester, address l2erc20, address l1erc721, address l2erc721) public {
        ...
        L2StandardBridge(payable(Predeploys.L2_STANDARD_BRIDGE))
            .withdraw({_l2Token: l2erc20, _amount: 10_000 ether, _minGasLimit: 200_000, _extraData: bytes("")});
        console.log("erc20 withdrawal initiated");

        L2ERC721Bridge(payable(Predeploys.L2_ERC721_BRIDGE))
            .bridgeERC721({
                _localToken: l2erc721, _remoteToken: l1erc721, _tokenId: 0, _minGasLimit: 200_000, _extraData: bytes("")
            });
